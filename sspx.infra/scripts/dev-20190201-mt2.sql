...
BEGIN
	...
	IF @AsChild = 1
		SET @ParentItemId = @PasteItemNodeId
	...
	IF @IsCut = 0 AND @ItemOnly = 1 
		INSERT INTO  @NodeId (ItemId, ParentId, SortOrder)
		SELECT TemplateVersionItemsKey, ParentTemplateVersionItemsKey, SortOrder
		FROM dbo.SSPX_TemplateVersionItems (NOLOCK) WHERE TemplateVersionItemsKey = @CopyItemNodeId
	ELSE 
		INSERT INTO @NodeId (ItemId, ParentId, SortOrder)
